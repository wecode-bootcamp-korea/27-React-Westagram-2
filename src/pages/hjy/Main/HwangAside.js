        ...
        <div className="asideInner">
          <div className="profile">
            ...
            <span className="profileDescription">
              <p className="englishName"><b>dududweb</b></p>
          ...
          <div className="storyFeed">
            ...
            <div className="storyFeedHeadWrap">
              ...
              <span className="storyFeedAllView"><Link to="#"><b>모두 보기</b></Link></span>
            </div>
            <div className="storyFeedBodyWrap">
              <div className="storyProfile">
                <span className="storyProfileImg">
                  <Link to="#"><img src="/images/webprofile1.png" alt=""/></Link>
                </span>
                <span className="storyProfileDescription">
                  <p className="storyEnglishName"><Link to="#"><b>dududweb</b></Link></p>
              ...
              <div className="storyProfile">
                <span className="storyProfileImg">
                  <Link to="#"><img src="/images/webprofile3.png" alt=""/></Link>
                </span>
                <span className="storyProfileDescription">
                  <p className="storyEnglishName"><Link to="#"><b>dududweb</b></Link></p>
                  <p className="storyLastTime">2시간 전</p>
              ...
              <div className="storyProfile">
                <span className="storyProfileImg">
                  <Link to="#"><img src="/images/webprofile4.png" alt=""/></Link>
                </span>
                <span className="storyProfileDescription">
                  <p className="storyEnglishName"><Link to="#"><b>dududweb</b></Link></p>
                  <p className="storyLastTime">2시간 전</p>
              ...
              <div className="storyProfile">
                <span className="storyProfileImg">
                  <Link to="#"><img src="img/webprofile5.png" alt=""/></Link>
                </span>
                <span className="storyProfileDescription">
                  <p className="storyEnglishName"><Link to="#"><b>dududweb</b></Link></p>
                  <p className="storyLastTime">2시간 전</p>
            ...
            <div className="storyFeedBodyWrap">
              ...
              <div className="storyProfile">
                <span className="storyProfileImg">
                  <Link to="#"><img src="/images/webprofile5.png" alt=""/></Link>
                </span>
                <span className="storyProfileDescription">
                  <p className="storyEnglishName"><Link to="#"><b>dududweb</b></Link></p>
                  <p className="storyLastTime">2시간 전</p>
            ...
            <div className="storyWrap">
              ...
              <div className="storyFeedBodyWrap">
                <div className="storyProfile">
                  ...
                  <span className="storyProfileDescription">
                    <p className="storyEnglishName"><Link to="#"><b>sanghoonlee</b></Link></p>
                    <p className="storySameFollowersView">legend_님 외 12명이 팔로우중입니다.</p>
                  </span>
                </div>
                <div className="storyProfile">
                  <span className="storyProfileImg">
